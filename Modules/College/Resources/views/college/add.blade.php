    ...
    <div>
        <div class="content">
            ...
            <div class="container-fluid">
                <div>
                    <div class="card-box">
                        <h4 class="header-title m-t-0">Add College </h4>
                                    ...
                                    <div class="card-body">
                                       ...
                                       @endforeach
                                        ...
                                        <div id="rootwizard">
                                            ...
                                            <form action="{{ route('admin.college.postAddEdit') }}" method="POST"
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name" parsley-trigger="change"
                                                                        ...
                                                                        class="form-control" id="userName" value="{{ old('name')}}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="estd"
                                                                        ...
                                                                        class="form-control" id="userName" value="{{ old('estd')}}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="location"
                                                                        ...
                                                                        class="form-control" id="userName" value="{{ old('location')}}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="website"
                                                                        ...
                                                                        class="form-control" id="userName" value="{{ old('website')}}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div>
                                                                    <label for="name">College / University Info<span
                                                                            class="text-danger">*</span></label>
                                                                    <textarea name="info"  class="tinymce-editor"></textarea>
                                                                </div>
                                                            </div>
                                                            <!-- end col -->
                                                        </div>
