                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="text-align: center">
                                            <a href="{{ url('/') }}" style="display: block;margin-bottom: 10px;"> <img
                                                    src="/backend/assets/images/logo-light.png" height="24"
                                                    alt="logo" /></a>
                                            <br />
                                        </td>
                                    </tr>
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            password has been generated for you. To reset
                                            your password, click the following link and follow the instructions.z
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            &mdash; <b>Blog</b> - Admin Dashboard
                                        </td>
                                    </tr>
                                </table>
                            </td>
