...
!(function (a) {
  ...
  (function (a) {
    ...
    a.extend(a.fn.editableContainer.Popup.prototype, {
      ...
      innerCss:
        a.fn.popover && a(a.fn.popover.defaults.template).find("p").length
          ? ".popover-content p"
          : ".popover-content",
          ...
          switch (
            ((f =
              "function" == typeof this.options.placement
                ? this.options.placement.call(this, l[0], this.$element[0])
            ...
            (e = l[0].offsetHeight),
            (f = b ? f.split(" ")[1] : f),
            (i = {top: c.top + c.height, left: c.left + c.width / 2 - d / 2}),
            (h = {top: c.top - e, left: c.left + c.width / 2 - d / 2}),
            (j = {top: c.top + c.height / 2 - e / 2, left: c.left - d}),
            (k = {top: c.top + c.height / 2 - e / 2, left: c.left + c.width}),
            f)
          ) {
            case "bottom":
              i.top + e > a(window).scrollTop() + a(window).height() &&
                (f =
                  h.top > a(window).scrollTop()
                    ? "top"
                    : k.left + d < a(window).scrollLeft() + a(window).width()
                    ? "right"
            ...
            case "right":
              k.left + d > a(window).scrollLeft() + a(window).width() &&
                (j.left > a(window).scrollLeft()
                  ...
                  : h.top > a(window).scrollTop()
                  ? (f = "top")
                  : h.top > a(window).scrollTop() && (f = "bottom"));
          }
          switch (f) {
            case "bottom":
              g = i;
      ...
      a.extend(b.prototype, {
        ...
        input2value: function () {
          if (this.getIsObjects()) {
            ...
            return c.length &&
              c[0].text.toLowerCase() === this.$input.val().toLowerCase()
              ? b
              : null;
          }
          return this.$input.val();
