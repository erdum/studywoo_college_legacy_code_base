...
$('#faculty').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".faculty").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
...
$('#course').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".course").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
        this.output.html(value);
...
$('#social_life').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".social_life").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
        this.output.html(value);
...
$('#placement').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".placement").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
        this.output.html(value);
...
$('#internship').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".internship").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
        this.output.html(value);
...
$('#interview').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".interview").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
        this.output.html(value);
...
$('#hostel').rangeslider({
    polyfill: false,
    onInit: function() {
        this.output = $(".hostel").html(this.$element.val());
    },
    onSlide: function(
        position, value) {
        this.output.html(value);
