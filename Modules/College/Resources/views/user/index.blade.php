                    ...
                    <div class="col-sm-8 offset-sm-4">
                        <div class="text-sm-right">
                            <button type="button" class="btn btn-danger waves-effect waves-light mb-2"
                                data-toggle="modal" data-target="#user-modal">Add User</button>
                                <button type="button" class="btn btn-outline-info waves-effect waves-light mb-2"
                                data-toggle="modal" data-target="#user-status">Change Status</button>
                                <button type="button" class="btn btn-outline-primary waves-effect waves-light mb-2"
                                data-toggle="modal" data-target="#reset-password">Reset Password</button>
                        </div>
                    </div><!-- end col-->
                </div>
...
@include('college::modal.user-modal')
@include('college::modal.user-status')
@include('college::modal.reset-password')
