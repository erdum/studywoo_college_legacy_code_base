{{-- @php
$adminDetail = auth()->user()->adminDetail;
@endphp --}}
    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                    ...
                    {{-- <img src="{{ asset($adminDetail->avatar) }}" alt="user-image" class="rounded-circle"> --}}
                    <span class="pro-user-name ml-1">
                        {{ $adminDetail->first_name ?? 'Erdum' }} <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="{{ route("admin.user.viewProfile") }}" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
        ...
        <div class="logo-box">
            <a href="index.html" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <span style="color: white">{{ SystemConfig::get('app_name') }}</span>
